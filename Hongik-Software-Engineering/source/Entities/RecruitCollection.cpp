...
/*
    ...
    기능    :  RecruitCollection 객체가 존재하면, 존재하는 객체를 반환하고 존재하지 않으면 새롭게 생성하여 반환함.
    전달 인자 : 없음
    반환값    :  RecruitCollection의 포인터 객체 
*/
...
/*
    ...
    반환값    : vector<string> 타입의 정보. 정보는 회사이름, 업무, 지원자수, 마감일 정보, 사업자 번호이다.
*/
